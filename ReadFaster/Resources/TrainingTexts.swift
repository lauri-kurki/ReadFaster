...
/// Level 1 is an onboarding text explaining the concept
enum TrainingTexts {
    
    static let allTexts: [TrainingText] = [
        onboarding,
        solarSystem,
        artOfWar,
        gatsby,
    ...
    // MARK: - Level 1: Onboarding (150 WPM)
    
    static let onboarding = TrainingText(
    ...
    // MARK: - Level 2: Science (200 WPM)
    
    static let solarSystem = TrainingText(
    ...
    // MARK: - Level 3: Philosophy (250 WPM)
    
    static let artOfWar = TrainingText(
    ...
    // MARK: - Level 4: Literature (350 WPM)
    
    static let gatsby = TrainingText(
    ...
    // MARK: - Level 5: Modern Fiction (500 WPM)
    
    static let futureCity = TrainingText(
